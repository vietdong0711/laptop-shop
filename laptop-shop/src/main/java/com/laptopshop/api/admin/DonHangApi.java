...
public class DonHangApi {
	...
	public List<DonHang> thongKeNgay(@RequestParam("from") String from, @RequestParam("to") String to) throws ParseException {
		return donHangService.dsDonHangTheoThoiGian(from,to);
	}
