...
<tr class="cart_line" id="item${sanpham.id}">
		...
		<td>
			<input size="4"	class="input_num_cart" type="number"  value="${quanity[sanpham.id]}" min="1" max="${sanpham.donViKho}" onChange="changeQuanity(${sanpham.id},this.value,${sanpham.donGia})">
		</td>
